...
export function ChatMockup() {
  ...
  return (
    <div ref={containerRef} className="w-full max-w-md mx-auto rounded-lg border border-border bg-card overflow-hidden font-mono text-xs">
      {/* Header */}
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border bg-[var(--bg-elevated)]">
      ...
      {/* Chat Area */}
      <div className="p-3 space-y-2 min-h-[180px] bg-[var(--bg-elevated)]">
        {/* User message */}
        ...
        <AnimatePresence mode="wait">
          {phase === "typing" && (
            ...
            >
              <div className="rounded-lg bg-[var(--bg-subtle)] border border-border px-3 py-2 text-[11px] text-muted-foreground">
          ...
          {(phase === "streaming" || phase === "done") && (
            <motion.div
              ...
              className="flex justify-start"
            >
              <div className="rounded-lg bg-[var(--bg-subtle)] border border-border px-3 py-2 max-w-[80%] text-[11px] text-foreground leading-relaxed">
                {streamedText}
                {phase === "streaming" && (
      ...
      {/* Input Bar */}
      <div className="flex items-center gap-2 px-3 py-2 border-t border-border bg-[var(--bg-elevated)]">
        <div className="flex-1 rounded-md bg-[var(--bg-subtle)] border border-border px-2 py-1.5 text-[11px] text-muted-foreground">
          Type a message...
        </div>
