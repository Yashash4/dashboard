...
export function DashboardMockup() {
  ...
  return (
    ...
    >
      <div className="flex">
        {/* Mini Sidebar */}
        <div className="w-32 shrink-0 border-r border-border bg-[#191919] p-2 space-y-0.5">
            ...
            <div
              ...
              className={`px-2 py-1.5 rounded-md text-[11px] ${
                item.active
                  ...
                  : "text-muted-foreground hover:bg-[#222222]"
              }`}
            >
              {item.label}
            </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {numericStats.map((stat, i) => (
              <motion.div
                ...
                className="rounded-md border border-border bg-[#222222] p-2 text-center"
              >
          ...
          <div className="space-y-1.5">
            ...
            {activityItems.map((item, i) => (
              <motion.div
                ...
                className="flex items-center justify-between rounded-md border border-border bg-[#222222] px-2 py-1.5"
              >
