...
const plans = [
  {
    ...
    features: [
      ...
      "Agent Store — browse, deploy, chat",
      "Full OpenClaw dashboard access",
...
const comparisonRows = [
  ...
  { label: "Model switching", starter: "1/cycle", pro: "Instant", ultra: "Instant", enterprise: "Instant" },
  ...
  { label: "Logs & Analytics", starter: false, pro: true, ultra: true, enterprise: true },
  { label: "API Access", starter: false, pro: true, ultra: true, enterprise: true },
  ...
  { label: "Custom agents", starter: false, pro: false, ultra: false, enterprise: true },
