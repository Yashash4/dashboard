...
export default function ApiDocs() {
  ...
  "agent": "support"
      ...
      <section id="knowledge-base" className="mb-20 scroll-mt-24">
        ...
        <Callout type="tip">
          See the full{" "}
          <Link href="/docs/knowledge-base" className="text-primary hover:underline">
            Knowledge Base API Reference
          </Link>{" "}
          for document upload, search, and management endpoints.
        </Callout>

        <h3 className="text-white font-semibold mb-4 mt-6">How It Works</h3>
        ...
        <div className="border border-white/10 overflow-hidden">
          {[
            ...
            },
            {
              ...
              desc: "You used an unsupported HTTP method (e.g. GET instead of POST).",
              examples: [
                '"Method Not Allowed"',
              ],
            },
...
def call_with_retry(fn, retries=3):
    ...
    raise Exception("Rate limit: max retries exceeded")`}
      ...
      <section id="api-keys" className="mb-20 scroll-mt-24">
        ...
        <Callout type="warning">
          The key management endpoints below require <strong>dashboard session authentication</strong> (cookie-based),
          not Bearer API key auth. These are meant for programmatic key management from your
          logged-in dashboard session, not from external API clients.
        </Callout>
  ...
  "success": true
      ...
      <section id="sdks" className="mb-20 scroll-mt-24">
        ...
        <p className="text-white/50 text-[13px] mb-6">
          Official SDKs are in development. Check back soon for:
        </p>
        <div className="grid sm:grid-cols-2 gap-3 mb-8">
          {[
            { lang: "Python", status: "Coming soon" },
            { lang: "JavaScript / TypeScript", status: "Coming soon" },
            { lang: "Go", status: "Coming soon" },
            { lang: "Ruby", status: "Coming soon" },
          ].map((sdk) => (
            <div
              key={sdk.lang}
        ...
        <Callout type="tip">
          The ClawHQ API follows the OpenAI-compatible format. Many existing
          HTTP client libraries and tools work out of the box — no SDK required.
        </Callout>

        <h3 className="text-white font-semibold mb-4 mt-6">Related Documentation</h3>
        <div className="grid sm:grid-cols-2 gap-3 mb-8">
          <Link
            href="/docs/webhooks"
            className="border border-white/10 p-4 bg-white/[0.01] hover:border-primary/30 hover:bg-primary/5 transition-all group"
          >
            <div className="font-mono text-[10px] text-white/30 uppercase tracking-widest mb-1">
              02
            </div>
            ...
            <p className="text-white/30 text-[12px] mt-1">
              Event-driven delivery with HMAC signing
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-white/30 text-[12px] mt-1">
              Document upload, chunking, and RAG search
            </p>
          </Link>
        </div>
